var questionArray = [
  {
    ...
    optionsList: [
      "A)  Source Engine Organization",
      "B)  Social Engineer Operator",
  ...
  },
  {
    ...
    optionsList: [
      "A)  let's you control main axis",
      "B)  makes it responsive",
  ...
  },
  {
    ...
    optionsList: [
      ...
      "B)  an attribute is any tag on your page, an element provides details about an attribute",
  ...
  {
    question:
      "What is a plain language description of the steps that an algorithm or application must complete?",
    optionsList: [
      "A)  expression",
      "B)  condition",
      "C)  declaration",
